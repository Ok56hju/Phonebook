...
public class ContactHelper extends BaseHelper {
    ...
    public int sizeOfContacts() {
        if (isElementPresent(By.cssSelector(".contact-item_card__2SOIM"))) {
            return ApplicationMagager.driver.findElements(By.cssSelector(".contact-item_card__2SOIM")).size();
        }
        return 0;
    }
    ...
    public boolean isContactCreated(String text) {
        List<WebElement> contacts = ApplicationMagager.driver.findElements(By.cssSelector("h2"));
